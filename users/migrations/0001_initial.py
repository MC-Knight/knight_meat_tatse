    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'Client'), (2, 'Cashier'), (3, 'Admin')], default=1)),
                ...
                ('phone_number', models.CharField(blank=True, max_length=155, null=True)),
